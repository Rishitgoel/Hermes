...
- ✅ **Secret Drift detection live**: compares live AWS Secrets Manager key lists against registered keys in infra deployment manifests; scan cron job runs on the scheduler; surfaces Solve drift (opens PR) and Merge PR flows; supports ignoring/muting dangling key alerts.
