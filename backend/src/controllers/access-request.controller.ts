...
export class AccessRequestController extends BaseController {
  ...
  async createRequestsBulk(
    ...
    try {
      ...
      const result = await accessWorkflowService.createRequestsBulk(
        requester,
        requests,
        duration,
      );
        ...
        try {
          ...
          if (
            ...
            throw new AuthorizationError(
              'You do not have permission to review requests for this group',
            );
          }
